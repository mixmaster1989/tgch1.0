...
if usdc >= balancer.min_balance_threshold:
    ...
    if safe_amount >= 5.0:
        ...
        print('🔄 Теперь система сможет автоматически конвертировать USDT→USDC при необходимости!')
    else:
    ...
    if usdt >= 10.0:
        ...
        print('🔄 При следующей попытке балансировки система автоматически конвертирует!')
    else:
        print(f'❌ USDT тоже недостаточно (${usdt:.2f})')
        
print()
print('🎉 БАЛАНСИРОВЩИК ГОТОВ К РАБОТЕ 50/50!')
