...
class BalanceMonitor:
    ...
    def __init__(self):
        ############################################################
        # ⚙️ ИНИЦИАЛИЗАЦИЯ
        # Назначение: клиенты API, Telegram, фильтры, основные настройки
        ############################################################
        self.mex_api = MexAPI()
        ...
        self.max_purchase_amount = 50.0   # Максимальная сумма одной покупки ($50 USDC)
    ...
    ############################################################
    # 💰 БАЛАНСЫ: USDC / USDT
    # Назначение: чтение актуальных свободных остатков
    ############################################################
    ...
    ############################################################
    # 🔄 ОБЕСПЕЧЕНИЕ USDC
    # Назначение: при нехватке USDC — докупить за USDT
    ############################################################
    ...
    ############################################################
    # 💹 ЦЕНЫ И ТЕКУЩЕЕ СОСТОЯНИЕ ПОРТФЕЛЯ
    # Назначение: получение цен, вычисление распределения BTC/ETH
    ############################################################
    ...
    ############################################################
    # 🧮 РАСЧЁТ СУММЫ ПОКУПОК
    # Назначение: определение сумм BTC/ETH с учётом фильтров и ребаланса
    ############################################################
    ...
    ############################################################
    # 🛡️ ПРОВЕРКИ БЕЗОПАСНОСТИ ПЕРЕД ПОКУПКОЙ
    # Назначение: остаток USDC после покупки, кулдауны
    ############################################################
    ...
    ############################################################
    # 🔐 БЕЗОПАСНАЯ СУММА ПОКУПКИ
    # Назначение: ограничение одной сделки и остатка USDC
    ############################################################
    ...
    ############################################################
    # 📚 СТАКАН И ЦЕНООБРАЗОВАНИЕ
    # Назначение: данные ордербука и расчёт лимитной цены
    ############################################################
    ...
    # Назначение: ретраи, корректировка количества, статусы мейкер/тейкер
    ############################################################
    ...
    ############################################################
    # 🤖 АВТОПОКУПКА
    # Назначение: формирование плана и исполнение сделок, сбор результата
    ############################################################
    ...
    ############################################################
    # 📨 ОТЧЁТ ДЛЯ TELEGRAM
    # Назначение: форматирование результата сделки для уведомлений
    ############################################################
    ...
    ############################################################
    # 🔎 ОСНОВНОЙ ШАГ МОНИТОРИНГА
    # Назначение: проверка балансов, условий и запуск покупки
    ############################################################
    ...
    ############################################################
    # ♻️ ЦИКЛ МОНИТОРИНГА
    # Назначение: бесконечный цикл проверки и покупок с интервалом
    ############################################################
...
############################################################
# 🧪 ТЕСТЫ И САМООБСЛУЖИВАНИЕ МОДУЛЯ
# Назначение: локальный тест и самостоятельный запуск
############################################################
